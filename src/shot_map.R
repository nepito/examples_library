...
df_all_players <- read_csv("/workdir/tests/data/shots_match.csv", show_col_types = FALSE) |>
  transmute(
...
base <- df |>
  ...
  labs(
    title = "Goleadores de la Champions",
    subtitle = "Top 6 de goleo | Champions 2024/2025 | Tomado del código de @TonyElHabr",
    y = NULL,
    x = NULL
  ) +
  ## 4 stat label hexes
